...
# " [\#number](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/<number>)
...
for line in fileinput.input(inplace=1):
    line = re.sub(r"\s\\#([0-9]+)", r" [\\#\1](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/\1)", line.rstrip())
    print(line)