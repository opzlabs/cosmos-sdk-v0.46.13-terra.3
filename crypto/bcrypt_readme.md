...
```bash
go test -v --bench github.com/opzlabs/cosmos-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/opzlabs/cosmos-sdk/crypto/keys/mintkey
...
PASS
ok  	github.com/opzlabs/cosmos-sdk/crypto/keys/mintkey	12.093s
```
