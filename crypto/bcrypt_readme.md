...
```bash
go test -v --bench github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/crypto/keys/mintkey
...
PASS
ok  	github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/crypto/keys/mintkey	12.093s
```
