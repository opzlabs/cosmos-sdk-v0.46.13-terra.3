...
// See issue https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/9165
...
func TestCompactBitArrayGetSetIndex(t *testing.T) {
	...
	for i := 0; i < numTests; i++ {
		...
		for j := 0; j < numBitsPerArr; j++ {
			...
			// panic. See issue https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/9164.
