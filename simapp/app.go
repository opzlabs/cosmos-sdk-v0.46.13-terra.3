...
import (
	...
	nodeservice "github.com/opzlabs/cosmos-sdk/client/grpc/node"
	...
	"github.com/opzlabs/cosmos-sdk/store/streaming"
	...
	"github.com/opzlabs/cosmos-sdk/x/auth"
	"github.com/opzlabs/cosmos-sdk/x/auth/ante"
	authkeeper "github.com/opzlabs/cosmos-sdk/x/auth/keeper"
	"github.com/opzlabs/cosmos-sdk/x/auth/posthandler"
	authsims "github.com/opzlabs/cosmos-sdk/x/auth/simulation"
	...
	vestingtypes "github.com/opzlabs/cosmos-sdk/x/auth/vesting/types"
	"github.com/opzlabs/cosmos-sdk/x/authz"
	authzkeeper "github.com/opzlabs/cosmos-sdk/x/authz/keeper"
	authzmodule "github.com/opzlabs/cosmos-sdk/x/authz/module"
	"github.com/opzlabs/cosmos-sdk/x/bank"
	bankkeeper "github.com/opzlabs/cosmos-sdk/x/bank/keeper"
	banktypes "github.com/opzlabs/cosmos-sdk/x/bank/types"
	"github.com/opzlabs/cosmos-sdk/x/capability"
	capabilitykeeper "github.com/opzlabs/cosmos-sdk/x/capability/keeper"
	capabilitytypes "github.com/opzlabs/cosmos-sdk/x/capability/types"
	"github.com/opzlabs/cosmos-sdk/x/crisis"
	crisiskeeper "github.com/opzlabs/cosmos-sdk/x/crisis/keeper"
	crisistypes "github.com/opzlabs/cosmos-sdk/x/crisis/types"
	distr "github.com/opzlabs/cosmos-sdk/x/distribution"
	distrclient "github.com/opzlabs/cosmos-sdk/x/distribution/client"
	distrkeeper "github.com/opzlabs/cosmos-sdk/x/distribution/keeper"
	distrtypes "github.com/opzlabs/cosmos-sdk/x/distribution/types"
	...
	feegrantkeeper "github.com/opzlabs/cosmos-sdk/x/feegrant/keeper"
	feegrantmodule "github.com/opzlabs/cosmos-sdk/x/feegrant/module"
	...
	govkeeper "github.com/opzlabs/cosmos-sdk/x/gov/keeper"
	govtypes "github.com/opzlabs/cosmos-sdk/x/gov/types"
	govv1 "github.com/opzlabs/cosmos-sdk/x/gov/types/v1"
	govv1beta1 "github.com/opzlabs/cosmos-sdk/x/gov/types/v1beta1"
	"github.com/opzlabs/cosmos-sdk/x/group"
	groupkeeper "github.com/opzlabs/cosmos-sdk/x/group/keeper"
	groupmodule "github.com/opzlabs/cosmos-sdk/x/group/module"
	"github.com/opzlabs/cosmos-sdk/x/mint"
	mintkeeper "github.com/opzlabs/cosmos-sdk/x/mint/keeper"
	minttypes "github.com/opzlabs/cosmos-sdk/x/mint/types"
	"github.com/opzlabs/cosmos-sdk/x/nft"
	nftkeeper "github.com/opzlabs/cosmos-sdk/x/nft/keeper"
	nftmodule "github.com/opzlabs/cosmos-sdk/x/nft/module"
	"github.com/opzlabs/cosmos-sdk/x/params"
	paramsclient "github.com/opzlabs/cosmos-sdk/x/params/client"
	paramskeeper "github.com/opzlabs/cosmos-sdk/x/params/keeper"
	paramstypes "github.com/opzlabs/cosmos-sdk/x/params/types"
	paramproposal "github.com/opzlabs/cosmos-sdk/x/params/types/proposal"
	"github.com/opzlabs/cosmos-sdk/x/slashing"
	slashingkeeper "github.com/opzlabs/cosmos-sdk/x/slashing/keeper"
	...
	"github.com/opzlabs/cosmos-sdk/x/upgrade"
	upgradeclient "github.com/opzlabs/cosmos-sdk/x/upgrade/client"
	upgradekeeper "github.com/opzlabs/cosmos-sdk/x/upgrade/keeper"
...
func NewSimApp(
	...
	*/
	...
	// See: https://github.com/opzlabs/cosmos-sdk/blob/release/v0.46.x/x/gov/spec/01_concepts.md#proposal-messages
