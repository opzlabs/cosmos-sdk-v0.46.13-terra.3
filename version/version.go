...
//
//	go build -X github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/version.Name=gaia \
//	 -X github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/version.AppName=gaiad \
//	 -X github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/version.Version=1.0 \
//	 -X github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/version.Commit=f0f7b7dab7e36c20b757cebce0e8f4fc5b95de60 \
//	 -X "github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/version.BuildTags=linux darwin amd64"
package version
...
func getSDKVersion() string {
	...
	for _, dep := range deps.Deps {
		if dep.Path == "github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3" {
