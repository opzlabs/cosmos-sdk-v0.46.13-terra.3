...
import (
	...
	signing "github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/types/tx/signing"
...
type TxBody struct {
	...
	// but should be called `note` instead (see https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/9122).
...
type Fee struct {
	...
	Amount github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/types.Coins" json:"amount"`
