...
import (
	...
	signing "github.com/opzlabs/cosmos-sdk/types/tx/signing"
...
type TxBody struct {
	...
	// but should be called `note` instead (see https://github.com/opzlabs/cosmos-sdk/issues/9122).
...
type Fee struct {
	...
	Amount github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/opzlabs/cosmos-sdk/types.Coins" json:"amount"`
