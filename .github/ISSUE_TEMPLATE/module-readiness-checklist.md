...
- [ ] API audit (at least 1 person) (@assignee)
  ...
  - [ ] Is everything well documented (inline godoc as well as [`/spec/` folder](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/main/docs/spec/SPEC-SPEC.md) in module directory)
