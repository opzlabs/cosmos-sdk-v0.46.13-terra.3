...
on behalf of one account to other accounts. The design is defined in the [ADR 030](https://github.com/opzlabs/cosmos-sdk/blob/main/docs/architecture/adr-030-authz-module.md).
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/authz/authorizations.go#L11-L25
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/proto/cosmos/authz/v1beta1/authz.proto#L13-L20

+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/authz/generic_authorization.go#L16-L29
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/proto/cosmos/bank/v1beta1/authz.proto#L10-L19

+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/bank/types/send_authorization.go#L23-L38
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/proto/cosmos/staking/v1beta1/authz.proto#L10-L33

+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/staking/types/authz.go#L15-L35
