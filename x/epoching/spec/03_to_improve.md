...
// — we should define some new invariants that help check that everything is working smoothly with these new changes for 3 modules e.g. https://github.com/opzlabs/cosmos-sdk/blob/main/x/staking/keeper/invariants.go
