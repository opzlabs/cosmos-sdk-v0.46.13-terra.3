...
func (k Keeper) AllocateTokens(
	...
	// general discussions here: https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/2906#issuecomment-441867634
	...
	//
	// Ref: https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/pull/3099#discussion_r246276376
	for _, vote := range bondedVotes {
		validator := k.stakingKeeper.ValidatorByConsAddr(ctx, vote.Validator.Address)

		// TODO: Consider micro-slashing for missing votes.
		//
		// Ref: https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/2525#issuecomment-430838701
