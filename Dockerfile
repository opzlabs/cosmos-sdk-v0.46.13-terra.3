...
WORKDIR /go/src/github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3
...
COPY --from=build-env /go/src/github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/build/simd /usr/bin/simd
