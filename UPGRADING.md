...
## [v0.46.x](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/releases/tag/v0.46.0)
...
For the exhaustive list of API renaming, please refer to the [CHANGELOG](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/main/CHANGELOG.md).
...
The `third_party/proto` folder that existed in [previous version](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/tree/v0.45.3/third_party/proto) now does not contains directly the [proto files](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/tree/release/v0.46.x/third_party/proto).
