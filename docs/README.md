...
* **[Cosmos SDK API Reference](https://pkg.go.dev/github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3)**: Godocs of the Cosmos SDK.
...
See the [DOCS_README.md](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/main/docs/DOCS_README.md) for details of the build process and considerations when making changes.
