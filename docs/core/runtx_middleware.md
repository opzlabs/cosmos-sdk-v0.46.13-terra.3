...
More context can found in the corresponding [ADR-022](../architecture/adr-022-custom-panic-handling.md) and the implementation in [recovery.go](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/tree/v0.46.0-rc1/baseapp/recovery.go).

## Interface

+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/baseapp/recovery.go#L11-L14
