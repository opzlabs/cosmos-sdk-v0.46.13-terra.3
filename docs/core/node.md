...
* Then, the `config` is retrieved and config parameters are set. This mainly involves setting the Bech32 prefixes for [addresses](../basics/accounts.md#addresses).
  +++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/types/config.go#L14-L29
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/simapp/simd/main.go
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/server/start.go#L209-L209
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/simapp/simd/cmd/root.go#L246-L295

Then, the instance of `app` is used to instantiate a new Tendermint node:

+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/server/start.go#L291-L294
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/server/start.go#L296-L298
