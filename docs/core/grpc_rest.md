...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/server/types/app.go#L45-L47
...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/proto/cosmos/bank/v1beta1/query.proto#L19-L22
...
The Cosmos SDK's [Swagger generation script](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/scripts/protoc-swagger-gen.sh) is a good place to start.
