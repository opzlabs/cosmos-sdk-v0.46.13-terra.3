...
On the Cosmos SDK, this functionality is provided by the[`SimApp`](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/simapp/app.go), which is a
`Baseapp` application that is used for running the [`simulation`](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/x/simulation) module.
...
Check the full list of flags [here](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/simapp/config.go#L32-L55).
...
3. From a `params.json` file where the initial state is pseudo-randomly generated but the module and simulation parameters can be provided manually.
   ...
   The list of available parameters are listed [here](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/simapp/config.go#L33-L57).
...
check the Cosmos SDK [Makefile](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/Makefile#L263-L299).

```bash
 $ go test -mod=readonly github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/simapp \
...
* Try adding logs to operations that are not logged. You will have to define a
  [Logger](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/x/staking/keeper/keeper.go#L60-L63) on your `Keeper`.
