...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/x/staking/keeper/keeper.go#L21-L29
...
For more, see an example of `keeper`'s [methods implementation from the `staking` module](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/x/staking/keeper/keeper.go).
...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/x/auth/keeper/account.go#L76-L90
