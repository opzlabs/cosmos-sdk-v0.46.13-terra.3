...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/types/tx_msg.go#L10-L22
...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/x/auth/migrations/legacytx/stdsign.go#L20-L36

See an example implementation of a `message` from the `gov` module:

+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/x/gov/types/v1/msgs.go#L106-L138
...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/baseapp/abci.go#L756-L777
