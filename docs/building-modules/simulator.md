...
You can use the example [here](https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/distribution/simulation/decoder.go) from the distribution module to implement your store decoders.
...
You can check an example on how to create the randomized genesis [here](https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/staking/simulation/genesis.go).
...
You can see how an example of what is needed to fully test parameter changes [here](https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/staking/simulation/params.go)
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/staking/simulation/operations.go#L17-L75
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/distribution/module.go
