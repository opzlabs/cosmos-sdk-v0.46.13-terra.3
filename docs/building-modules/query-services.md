...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/types/queryable.go#L9
...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/x/bank/keeper/grpc_query.go
...
For a deeper look at `querier`s, see this [example implementation of a `querier` function](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/x/gov/keeper/querier.go) from the bank module.
