...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/types/invariant.go#L9
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/staking/keeper/invariants.go#L12-L21

For more, see an example of [`Invariant`s implementation from the `staking` module](https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/staking/keeper/invariants.go).
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/types/invariant.go#L14-L17
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/crisis/keeper/keeper.go#L49-L53
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/crisis/abci.go#L12-L21
