...
Registration of errors is handled via the [`errors` package](https://github.com/opzlabs/cosmos-sdk/blob/main/errors/errors.go).

Example:

+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/distribution/types/errors.go#L1-L21
...
Note, the Cosmos SDK provides a core set of *common* errors. These errors are defined in [`types/errors/errors.go`](https://github.com/opzlabs/cosmos-sdk/blob/main/types/errors/errors.go).
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/bank/keeper/keeper.go#L143-L184
