...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/proto/cosmos/auth/v1beta1/genesis.proto
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/auth/module.go#L45-L49
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/auth/types/genesis.go#L61-L74
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/auth/keeper/genesis.go#L8-L27
...
+++ https://github.com/opzlabs/cosmos-sdk/blob/v0.46.0-rc1/x/auth/keeper/genesis.go#L29-L41
