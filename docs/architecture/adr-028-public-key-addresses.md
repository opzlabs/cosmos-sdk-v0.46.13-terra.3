...
Issue [\#3685](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/3685) identified that public key
...
In [\#5694](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/5694) we discussed various solutions.
...
* Support currently used tools - we don't want to break an ecosystem, or add a long adaptation period. Ref: https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/8041
