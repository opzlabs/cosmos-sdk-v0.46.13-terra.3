...
* 2020 August 19: Move sequence field from `SignDoc` to `SignerInfo`, as discussed in [#6966](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/6966).
...
Based on detailed discussions ([\#6030](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/6030)
and [\#6078](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/6078)), the original
...
As was discussed extensively in [\#6078](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/6078),
...
(https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/6078#issuecomment-624400188) to
...
import "github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/client"
import "github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/client/tx"
...
(\*Documented as option (3) in https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/6078#issuecomment-628026933)
...
(_Documented as option (1)(a) in https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/6078#issuecomment-628026933_)
