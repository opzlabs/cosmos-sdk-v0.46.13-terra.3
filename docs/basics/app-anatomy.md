...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/simapp/app.go#L151-L193
...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/server/types/app.go#L57-L59
...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/simapp/app.go#L204-L474

### InitChainer

The `InitChainer` is a function that initializes the state of the application from a genesis file (i.e. token balances of genesis accounts). It is called when the application receives the `InitChain` message from the Tendermint engine, which happens when the node is started at `appBlockHeight == 0` (i.e. on genesis). The application must set the `InitChainer` in its [constructor](#constructor-function) via the [`SetInitChainer`](https://pkg.go.dev/github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/baseapp#BaseApp.SetInitChainer) method.
...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/simapp/app.go#L514-L522
...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/simapp/params/encoding.go#L9-L16
...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/simapp/encoding.go#L8-L19
...
+++ https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/v0.46.0-rc1/proto/cosmos/bank/v1beta1/tx.proto#L12-L19
...
::: warning
A patch introduced in `go-grpc v1.34.0` made gRPC incompatible with the `gogoproto` library, making some [gRPC queries](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/8426) panic. As such, the Cosmos SDK requires that `go-grpc <=v1.33.2` is installed in your `go.mod`.
...
Please see [issue #8392](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/issues/8392) for more info.
:::
