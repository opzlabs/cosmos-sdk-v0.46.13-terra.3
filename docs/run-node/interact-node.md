...
The list of all available gRPC query endpoints is [coming soon](https://github.com/opzlabs/cosmos-sdk/issues/7786).
...
Add below line to `go.mod` to replace protobuf, read more [#8469](https://github.com/opzlabs/cosmos-sdk/issues/8469)
...
```bash
go get github.com/opzlabs/cosmos-sdk@main
```
...
You can replace the query client (here we are using `x/bank`'s) with one generated from any other Protobuf service. The list of all available gRPC query endpoints is [coming soon](https://github.com/opzlabs/cosmos-sdk/issues/7786).
