...
If you want to open a PR in Cosmos SDK to update the documentation, please follow the guidelines in [`CONTRIBUTING.md`](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/tree/main/CONTRIBUTING.md#updating-documentation).
...
Then, edit the `swagger.yaml` manually; it is found [here](https://github.com/opzlabs/cosmos-sdk-v0.46.13-terra.3/blob/main/client/lcd/swagger-ui/swagger.yaml)
