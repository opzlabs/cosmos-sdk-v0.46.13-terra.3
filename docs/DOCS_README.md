...
If you want to open a PR in Cosmos SDK to update the documentation, please follow the guidelines in [`CONTRIBUTING.md`](https://github.com/opzlabs/cosmos-sdk/tree/main/CONTRIBUTING.md#updating-documentation).
...
Then, edit the `swagger.yaml` manually; it is found [here](https://github.com/opzlabs/cosmos-sdk/blob/main/client/lcd/swagger-ui/swagger.yaml)
